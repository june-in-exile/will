...
interface IJsonCidVerifier {
     ...
     */
    function buildStandardizedJson(JsonObject memory jsonObj) external pure returns (string memory);
     ...
     */
    function buildStandardizedJson(TypedJsonObject memory jsonObj) external pure returns (string memory);
     ...
     */
    function getJsonBytes(string memory json) external pure returns (bytes memory);
     ...
     */
    function getMultihash(bytes memory jsonBytes) external pure returns (bytes memory);
     ...
     */
    function stringEquals(string memory a, string memory b) external pure returns (bool);
}
