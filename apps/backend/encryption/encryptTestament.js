...
import { getEncryptionKey, getInitializationVector, aes256gcmEncrypt, chacha20Encrypt } from '../utils/crypto/encrypt.js';
...
const ENCRYPTION_CONFIG = {
    'aes-256-gcm': {
        ...
        ivSize: 12      // 12 bytes for AES-256-GCM
    },
    'chacha20': {
        keySize: 32,    // 32 bytes for ChaCha20
        ivSize: 12      // 12 bytes for ChaCha20
    }
};
