  ...
  describe("AES-128-CTR Encrypt Circuit", function () {
    describe("3 Bytes (With 13-byte Padding)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "3-byte AES-128-CTR encryption circuit constraints:",
          await circuit.getConstraintCount(), // 86504
        );
      });
      ...
      it("should work with known test vectors", async function (): Promise<void> {
        ...
        const iv = [
          0x57, 0xc9, 0x78, 0xbe, 0x1b, 0xe3, 0x40, 0xd6, 0x3b, 0x5e, 0xd5, 0x47,
          0xcb, 0x1f, 0xaa, 0x6a,
    ...
    describe("16 Bytes (1 Block)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "1-block AES-128-CTR encryption circuit constraints:",
          await circuit.getConstraintCount(), // 86816
        );
      });
      ...
      it("should work with known test vectors", async function (): Promise<void> {
        ...
        const ciphertext = [
          0x87, 0x45, 0x97, 0xdd, 0xc8, 0x52, 0xd7, 0xe0, 0x03, 0xc7, 0x46, 0x0c,
          0xfd, 0xc0, 0x9f, 0xe3,
    ...
    describe("47 Bytes (With 1-byte Padding)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "47-byte AES-128-CTR encryption circuit constraints:",
          await circuit.getConstraintCount(), // 260490
        );
      });
    ...
    describe("64 Bytes (4 Block)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "4-block AES-128-CTR encryption circuit constraints:",
  ...
  describe("AES-192-CTR Encrypt Circuit", function () {
    describe("30 Bytes (With 2-byte Padding)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "30-byte AES-192-CTR encryption circuit constraints:",
          await circuit.getConstraintCount(), // 199857
        );
      });
  ...
  describe("AES-256-CTR Encrypt Circuit", function () {
    describe("17 Bytes (With 15-byte Padding)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "17-byte AES-256-CTR encryption circuit constraints:",
          await circuit.getConstraintCount(), // 240313
        );
      });
    ...
    describe("64 Bytes (4 Block)", function () {
      beforeAll(async function (): Promise<void> {
        ...
        console.info(
          "4-block AES-256-CTR encryption circuit constraints:",
