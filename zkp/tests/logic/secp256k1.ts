...
import { bigIntsToPoint, concatBigInts, pointToBigInts } from "../util/index.js";

function secp256k1PointOnLine(x1: bigint[], y1: bigint[], x2: bigint[], y2: bigint[], x3: bigint[], y3: bigint[]): boolean {
...
function secp256k1PointOnTangent(x1: bigint[], y1: bigint[], x3: bigint[], y3: bigint[]): boolean {
    const p1 = { x: concatBigInts(x1), y: concatBigInts(y1), isInfinity: false };
    const p3 = { x: concatBigInts(x3), y: concatBigInts(y3), isInfinity: false };
...
export { secp256k1PointOnLine, secp256k1PointOnTangent, secp256k1PointOnCurve, secp256k1AddUnequal };