...
import { Bit, Byte, Uint256, Address, Estate, Nonce, Timestamp, Signature, Point } from "../type/index.js";
import { byteToBigInt, concatBigInts, splitBigInt, pointToHex, hexToPoint, addressBigintToHex } from "../util/conversion.js";
...
function recoverPublicKey(msghash: Uint256, r: Uint256, s: Uint256, v: Byte): Point {
    const signature = '0x' + (concatBigInts(r).toString(16).padStart(64, '0') + concatBigInts(s).toString(16).padStart(64, '0') + v.toString(16).padStart(2, '0'));
...
function verifySignature(signature: Signature, typedPermitDigest: Uint256, testator: Address): Bit {
    try {
...
const signature = hexToByte("0x8792602093a4f8d68e2fa48bf50cd105c45f95f6a614ed3632737ee9c4ae75a2081cb24113bfec49fbf8e52236f132bc292a15f82e6f475cccf0e2846b26c8861c") as Signature;

console.log("Result:", verifyPermit(testator, estates, nonce, deadline, will, signature));

export { hashPermit, hashTypedData, decodeSignature, publicKeyToAddress, verifySignature, verifyPermit }