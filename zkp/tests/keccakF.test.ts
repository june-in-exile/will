...
describe("ThetaStateArray Circuit", function () {
  ...
  describe("Theta Algorithm in KeccakF", function (): void {
    beforeAll(async function (): Promise<void> {
      ...
      circuit.setConstraint("theta state array");
    });
    ...
    it("should calculate correctly", async function (): Promise<void> {
      ...
      Keccak256.theta(lanes);
      const newStateArray = Keccak256Utils.lanesToStateArray(lanes);
