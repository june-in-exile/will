...
describe("Deserialize Circuits", function () {
  ...
  describe("Deserialize The Will", function () {
      ...
      const testCases = [
        {
          ...
          salt: splitBigInt(BigInt("0x709090f298f23a5c179aee70b7f4ad6ec3784f273e414889c99c4d1f7710d8f5")) as Uint256,
          ...
          signature: {
            r: splitBigInt(BigInt("0x6a530998e973a4c19078304df656de49a06ecc74988b94410ec605295db015dd")),
            s: splitBigInt(BigInt("0x2823d3fe682f8f1b6437c982d46cba08d1761a9721303da16185fcef17123e75")),
            v: 27,
          } as EcdsaSignature,
        },
        {
          ...
          salt: splitBigInt(BigInt("0xb1f48bd14750374db91306c88bc537b49fd7e3d9b8a79a1a2283e6db18f1ab7c")) as Uint256,
          ...
          signature: {
            r: splitBigInt(BigInt("0x8795d3e26d5166091b9b25a260022e46311ae45cc9d1cc744b787a6e406fecd1")),
            s: splitBigInt(BigInt("0x3f4a6eb5d3ae1a3c2a60590ed36b7a0220b84af1436f435d798b21e0ec489187")),
            v: 28,
          } as EcdsaSignature
        },
      ];
    ...
    it("should reject the serialized bytes with invalid signature", async function (): Promise<void> {
      const validSerializedBytes: Byte[] = hexToByte(
        "",
      );

      const serializedBytesInvalidSignature = validSerializedBytes.slice(0, -1).push(29); // invalid v value in signature

      await circuit.expectFail({ serializedBytes: serializedBytesInvalidSignature });
    });
  });
});
