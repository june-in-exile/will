...
describe("Deserialize Circuits", function () {
  ...
  describe("Deserialize The Will", function () {
    ...
    it("should return the correct elements in the will", async function (): Promise<void> {
      const testCases = [
        {
          ...
          will: BigInt(
            "0x1555c060bdD2ac0D37F1460f6B556b05BEc61497",
          ) as Address,
          nonce: 136952586996355266360424646101069432653n as Nonce,
          deadline: 1788771087 as Timestamp,
          signature: hexToByte(
            "0x6a530998e973a4c19078304df656de49a06ecc74988b94410ec605295db015dd2823d3fe682f8f1b6437c982d46cba08d1761a9721303da16185fcef17123e751b", // v = 27
          ) as Signature,
        },
        {
          serializedBytes: hexToByte(
          ...
          signature: hexToByte(
            "0x8795d3e26d5166091b9b25a260022e46311ae45cc9d1cc744b787a6e406fecd13f4a6eb5d3ae1a3c2a60590ed36b7a0220b84af1436f435d798b21e0ec4891871c",  // v = 28
          ) as Signature,
        },
      ]

      for (const { serializedBytes, testator, estates, will, nonce, deadline, signature, } of testCases) {
