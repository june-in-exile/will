...
//     let circuit8: CircomTester.CircuitInstance;  // 8-bit, range [0, 255]
//     let circuit6: CircomTester.CircuitInstance;   // 6-bit, range [0, 63]

//     beforeAll(async function (): Promise<void> {
//         try {
//             circuit6 = await compileCircuit("./shared/compenents/range.circom", {
//                 templateParams: ["6"]
//             });
//             circuit8 = await compileCircuit("./shared/compenents/range.circom", {
//                 templateParams: ["8"]
//             });
//         } catch (error) {
...
//             const testCases = [
//                 { input: 0, min: 0, max: 255 },
//                 { input: 1, min: 0, max: 255 },
//                 { input: 127, min: 0, max: 255 },
//                 { input: 254, min: 0, max: 255 },
//                 { input: 255, min: 0, max: 255 },
//             ];
