...
template MixColumn() {
    ...
    signal (s0_mul2, s0_mul3) <== (GFMul2()(in[0]), GFMul3()(in[0]));
    signal (s1_mul2, s1_mul3) <== (GFMul2()(in[1]), GFMul3()(in[1]));
    signal (s2_mul2, s2_mul3) <== (GFMul2()(in[2]), GFMul3()(in[2]));
    signal (s3_mul2, s3_mul3) <== (GFMul2()(in[3]), GFMul3()(in[3]));
