...
function get_dummy_point(n, k) {
    ...
    if (k == 3) {
        ...
        // Self-Calculated:
        // ret[0][0] = 12841891897255804443;
        // ret[0][1] = 2673685488914591858;
        // ret[0][2] = 8208947961671825091;
        // ret[0][3] = 16770615581224985476;
        // ret[1][0] = 18188747282752823003;
        // ret[1][1] = 16777333066489264453;
        // ret[1][2] = 1724884103647382360;
        // ret[1][3] = 15062930234956941326;
    }
    return ret;
}
