...
template GF128Multiply() {
    ...
    aBits <== BytesToBitsMsbFirst(16)(aBytes);
    bBits[0] <== BytesToBitsMsbFirst(16)(bBytes);
    ...
    cBytes <== BitsToBytesMsbFirst(16)(cBits[128]);
}
...
template GF128MultiplyOptimized() {
    ...
    aBits <== BytesToBitsMsbFirst(16)(aBytes);
    bBits <== BytesToBitsMsbFirst(16)(bBytes);
    ...
    // Convert final result bits back to bytes
    cBytes <== BitsToBytesMsbFirst(16)(cBits);
}
